...
API_ID = int(environ.get('API_ID', '12071719'))
API_HASH = environ.get('API_HASH', '783d16f3bec8b5753393c0799baac38c')
BOT_TOKEN = environ.get('BOT_TOKEN', '8297097214:AAHeXSCmtdIRG5-B9aR689l4-N9HGp-wSbU')
PORT = environ.get('PORT', '8082')

# Owners 
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '1796931299').split()]
OWNER_USERNAME = environ.get('OWNER_USERNAME', 'Opkills') # without @ or https://t.me/ 
...
AUTH_CHANNEL = int(environ.get('AUTH_CHANNEL', '-1002874199652'))
AUTH_REQ_CHANNEL = int(environ.get('AUTH_REQ_CHANNEL', '-1002779791560'))
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002852051467'))
LOG_API_CHANNEL = int(environ.get('LOG_API_CHANNEL', '-1002852051467')) 
LOG_VR_CHANNEL = int(environ.get('LOG_VR_CHANNEL', '-1002852051467'))
...
# Other Channel's
SUPPORT_GROUP = int(environ.get('SUPPORT_GROUP', '-1003015180880'))
...
TUTORIAL = environ.get("TUTORIAL", "https://t.me/Pyroflix")
TUTORIAL_2 = environ.get("TUTORIAL_2", "https://t.me/pyroflix")
TUTORIAL_3 = environ.get("TUTORIAL_3", "https://t.me/pyroflix")
...
SHORTENER_API2 = environ.get("SHORTENER_API2", "a7d1779bd097cdf9dd9eb5044f8423350f8d326e")
SHORTENER_WEBSITE2 = environ.get("SHORTENER_WEBSITE2", 'softurl.in')
SHORTENER_API3 = environ.get("SHORTENER_API3", "a7d1779bd097cdf9dd9eb5044f8423350f8d326e")
...
START_IMG = (environ.get('START_IMG', 'https://graph.org/file/11be37e22287b3d24b7f2.jpg')).split()
FORCESUB_IMG = environ.get('FORCESUB_IMG', 'https://i.ibb.co/ZNC1Hnb/ad3f2c88a8f2.jpg')
REFER_PICS = (environ.get("REFER_PICS", "https://envs.sh/PSI.jpg")).split() 
PAYPICS = (environ.get('PAYPICS', 'https://envs.sh/zjY.jpg')).split()
